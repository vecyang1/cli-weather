...
| Path | Owns | Example |
| --- | --- | --- |
| `src/cli_weather/` | Core package source code, configuration, models, engine, and providers | `src/cli_weather/weather_engine.py` |
| `src/cli_weather/providers/` | Multi-tier provider implementations (Open-Meteo, Met.no, wttr.in, Search) | `src/cli_weather/providers/open_meteo_provider.py` |
| `bin/` | Executable console wrappers (`weather`, `cli-weather`) | `bin/weather`, `bin/cli-weather` |
| `tests/` | Comprehensive test suite (unit tests, mock tests, and live e2e tests) | `tests/test_weather_engine.py` |
| `.github/workflows/` | Continuous integration workflows | `.github/workflows/test.yml` |
| `docs/` | Durable PRDs, API contracts, architecture notes | `docs/architecture.md`, `docs/configuration.md` |
